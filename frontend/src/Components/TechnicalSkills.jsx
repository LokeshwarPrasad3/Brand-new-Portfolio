    ...
    <>
      <div className="skill_page_container text-white flex flex-col items-center justify-center py-5 pb-14 font-overpass">
        ...
        <div className="skill_programming_lang skills_box_class ">
          <h3 className="py-2 text-lg">Programming Languages</h3>
          <div className="programming_language_container flex justify-center flex-wrap gap-6 items-center ">
        ...
        <div className="skill_programming_lang skills_box_class ">
          <h3 className="py-2 text-lg">Technologies</h3>
          <div className="programming_language_container flex justify-center flex-wrap gap-6 items-center ">
        ...
        <hr className="opacity-20 w-[60%]" />
        <div className="skill_programming_lang skills_box_class ">
          <h3 className="py-2 text-lg">Databases</h3>
          <div className="programming_language_container flex justify-center flex-wrap gap-6 items-center ">
        ...
        <hr className="opacity-20 w-[60%]" />
        <div className="skill_programming_lang skills_box_class ">
          <h3 className="py-2 text-lg">Version Control System</h3>
          <div className="programming_language_container flex justify-center flex-wrap gap-6 items-center ">
